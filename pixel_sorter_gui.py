...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy3.setHeightForWidth(self.t_image.sizePolicy().hasHeightForWidth())
        self.t_image.setSizePolicy(sizePolicy3)
        font = QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        sizePolicy4.setHeightForWidth(self.t_image_desc.sizePolicy().hasHeightForWidth())
        self.t_image_desc.setSizePolicy(sizePolicy4)
        font1 = QFont()
        ...
        sizePolicy5.setHeightForWidth(self.b_choose_image.sizePolicy().hasHeightForWidth())
        self.b_choose_image.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.b_load_current.sizePolicy().hasHeightForWidth())
        self.b_load_current.setSizePolicy(sizePolicy5)
        ...
        sizePolicy6.setHeightForWidth(self.l_loaded_image_preview.sizePolicy().hasHeightForWidth())
        self.l_loaded_image_preview.setSizePolicy(sizePolicy6)
        ...
        sizePolicy7.setHeightForWidth(self.line_major_1.sizePolicy().hasHeightForWidth())
        self.line_major_1.setSizePolicy(sizePolicy7)
        ...
        sizePolicy3.setHeightForWidth(self.t_image_mask.sizePolicy().hasHeightForWidth())
        self.t_image_mask.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.t_image_mask_desc.sizePolicy().hasHeightForWidth())
        self.t_image_mask_desc.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.b_choose_mask.sizePolicy().hasHeightForWidth())
        self.b_choose_mask.setSizePolicy(sizePolicy5)
        ...
        sizePolicy6.setHeightForWidth(self.l_loaded_mask_preview.sizePolicy().hasHeightForWidth())
        self.l_loaded_mask_preview.setSizePolicy(sizePolicy6)
        ...
        sizePolicy5.setHeightForWidth(self.b_choose_mask_folder.sizePolicy().hasHeightForWidth())
        self.b_choose_mask_folder.setSizePolicy(sizePolicy5)
        ...
        sizePolicy7.setHeightForWidth(self.line_major_2.sizePolicy().hasHeightForWidth())
        self.line_major_2.setSizePolicy(sizePolicy7)
        ...
        sizePolicy3.setHeightForWidth(self.t_interval_sorting.sizePolicy().hasHeightForWidth())
        self.t_interval_sorting.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.t_interval_sorting_desc.sizePolicy().hasHeightForWidth())
        self.t_interval_sorting_desc.setSizePolicy(sizePolicy4)
        ...
        sizePolicy3.setHeightForWidth(self.cb_interval_function.sizePolicy().hasHeightForWidth())
        self.cb_interval_function.setSizePolicy(sizePolicy3)
        ...
        sizePolicy5.setHeightForWidth(self.b_load_current_2.sizePolicy().hasHeightForWidth())
        self.b_load_current_2.setSizePolicy(sizePolicy5)
        ...
        sizePolicy7.setHeightForWidth(self.line_major_3.sizePolicy().hasHeightForWidth())
        self.line_major_3.setSizePolicy(sizePolicy7)
        ...
        sizePolicy3.setHeightForWidth(self.t_pixel_ordering.sizePolicy().hasHeightForWidth())
        self.t_pixel_ordering.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.t_pixel_ordering_desc.sizePolicy().hasHeightForWidth())
        self.t_pixel_ordering_desc.setSizePolicy(sizePolicy4)
        ...
        sizePolicy3.setHeightForWidth(self.cb_pixel_ordering_option.sizePolicy().hasHeightForWidth())
        self.cb_pixel_ordering_option.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.t_pixel_ordering_option_desc.sizePolicy().hasHeightForWidth())
        self.t_pixel_ordering_option_desc.setSizePolicy(sizePolicy4)
        ...
        sizePolicy7.setHeightForWidth(self.line_major_4.sizePolicy().hasHeightForWidth())
        self.line_major_4.setSizePolicy(sizePolicy7)
        ...
        sizePolicy3.setHeightForWidth(self.t_image_output.sizePolicy().hasHeightForWidth())
        self.t_image_output.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.t_save_location_desc.sizePolicy().hasHeightForWidth())
        self.t_save_location_desc.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.b_generate_pixel_sort.sizePolicy().hasHeightForWidth())
        self.b_generate_pixel_sort.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.b_save_image.sizePolicy().hasHeightForWidth())
        self.b_save_image.setSizePolicy(sizePolicy5)
        ...
        self.hl_image_preview = QHBoxLayout()
        self.hl_image_preview.setObjectName(u"hl_image_preview")
        self.hl_image_preview.setContentsMargins(0, 0, 0, 0)
        self.horizontalSpacer_10 = QSpacerItem(0, 5, QSizePolicy.Maximum, QSizePolicy.Minimum)

        self.hl_image_preview.addItem(self.horizontalSpacer_10)
        ...
        sizePolicy5.setHeightForWidth(self.b_open_in_native_viewer.sizePolicy().hasHeightForWidth())
        self.b_open_in_native_viewer.setSizePolicy(sizePolicy5)
